// @ts-nocheck -- Vendored React Bits component; keep project typechecks focused on local integration code.
...
`;
  ...
  return <div ref={mountRef} className={["liquid-ether-container", className].filter(Boolean).join(" ")} style={style} />;
}
